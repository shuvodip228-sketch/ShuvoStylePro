...
{Colors.CYAN}╔═══════════════════════════════════════════════════════════════╗
║                                                               ║
║              SHUVO DIP X HUNT  - TERMUX PRO v3.0                ║
║                                                               ║
║            Create Your Custom Cyberpunk Terminal              ║
║                                                               ║
║          {Colors.GRAY}Credits: SHUVOX/SHUVODIP{Colors.CYAN}                             ║
║    {Colors.GRAY}Telegram: https://t.me/SHUVODIP_BRO{Colors.CYAN}             ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝{Colors.RESET}
""")
...
def create_readme(name):
    """Create README file"""
    readme_content = f"""# {name} - SHUVO DIP PRO

Custom stylish terminal with advanced cyberpunk aesthetics.

🔗 **Project:** https://github.com/shuvodip228-sketch/ShuvoStylePro
...
{Colors.YELLOW}To remove and restore normal prompt:{Colors.RESET}
  {Colors.WHITE}python ShuvoStylePro{Colors.RESET}
  Then choose option [3] Remove Stylish Terminal
""")
    
    print(f"\n{Colors.MAGENTA}Created for: {Colors.BOLD}{name}{Colors.RESET}")
    print(f"{Colors.CYAN}Credits: {Colors.BOLD}SHUVODIPBRO/SHUVO X HUNT{Colors.RESET}")
